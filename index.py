...
while True:
    blank(1)
    breath(0.005,(170,170,170),5)
    blank(5)


    wipe(0.25,(100,170,200))
    time.sleep(3)
    #blank(5)
    wipe(0.25,(0,0,0))
    ...
    breath(0.01,(100,150,200),2)
    blank(2)
    breath(0.01,(100,150,200),2)
    blank(2)
    breath(0.005,(50,170,230),3)
    ...
    triangleBreath(1,0.02,(100,100,200),1)
    triangleBreath(2,0.02,(100,100,200),1)
    blank(5)
    triangleBreath(3,0.05,(100,100,200),1)
    blank(5)
    triangleBreath(4,0.05,(100,100,200),1)
    blank(5)
    triangleBreath(5,0.05,(100,100,200),1)
    blank(5)
    triangleBreath(6,0.05,(100,100,200),1)
    blank(5)
